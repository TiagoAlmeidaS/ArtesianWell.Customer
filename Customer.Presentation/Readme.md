...
Execute unit tests
```
    cd "Authentication.Presentation.WebServerless/test/Authentication.Presentation.WebServerless.Tests"
    dotnet test
```

Deploy application
```
    cd "Authentication.Presentation.WebServerless/src/Authentication.Presentation.WebServerless"
